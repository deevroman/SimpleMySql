 ...
 * Connection:
 *
 * $db = new SimpleMySQL(); // with default settings
 *
 * $opts = array(
 *        'user'    => 'user',
 *        'pass'    => 'pass',
 ...
 *        'charset' => 'latin1'
 * );
 * $db = new SimpleMySQL($opts); // with some of the default settings overwritten
 *
 ...
 *
 * $db = new SimpleMySQL(['mysqli' => $mysqli]);
 *
 * Some examples:
 *
...
class SimpleMySQL
{
     ...
     */
    public function getIndCol(...$args) {
        $index = array_shift($args);
        $query = $this->prepareQuery($args);
    ...
    protected function error($err) {
        throw new $this->exname(__CLASS__ . ": " . $err);
    }
